  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover p-4 text-popover-foreground shadow-lg ring-1 ring-foreground/10 outline-none duration-200 ease-in-out data-open:animate-in data-closed:animate-out",
          sideClasses[side],
          className
        )}
        {...props}
